...
void Keyboard(unsigned char key, int x, int y)
{
  switch (key)
  {
	...
	/* Cambiamos los valores con las teclas. */
	case 'a':
		bias += 0.01;
		break;
	case 'z':
  ...
  printf("============================\n");
	...
	if (specular == 0.0){
		printf("Specular: apagado.\n");
	}else{
		printf("Specular: encendido.\n");
	}

	if (fresnel == 0.0){
		printf("Fresnel: apagado.\n");
	}else{
		printf("Fresnel: encendido.\n");
	}
...
void render(){
	...
	shader->setUniform1f("specular",specular);
